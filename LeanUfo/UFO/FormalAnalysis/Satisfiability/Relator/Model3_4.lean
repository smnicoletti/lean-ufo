...
import LeanUfo.UFO.FormalAnalysis.Satisfiability.Relator.Model3_3

/-!
# Positive relator model: section 3.4
...
/-- Consistency witness for §3.4 of the positive relator model chain. -/
