...
import LeanUfo.UFO.FormalAnalysis.Satisfiability.Relator.Model3_2

/-!
# Positive relator model: section 3.3
...
/-- Consistency witness for §3.3 of the positive relator model chain. -/
