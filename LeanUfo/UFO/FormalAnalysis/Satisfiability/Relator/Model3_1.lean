...
/-!
# Positive relator model: section 3.1

The model chain uses one fixed domain: a relator, two qua individuals, three
substantials, one perdurant foundation, and four types. Later modules extend
the signature on this domain.
-/

namespace Relator.Model3_1
...
/-- Every type in the positive relator model has a fixed actual instance. -/
