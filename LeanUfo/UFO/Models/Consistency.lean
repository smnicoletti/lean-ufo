...
/--
Consistency checkpoint for UFO subsection 3.12 (relative to Lean):
axioms (a1)-(a101) + (inherited) structural assumptions from §§3.2-3.12
are jointly satisfiable.
-/
...
/--
Consistency checkpoint for UFO subsection 3.13 (relative to Lean):
axioms (a1)-(a104) + (inherited) structural assumptions from §§3.2-3.13
are jointly satisfiable.
-/
...
/--
Consistency checkpoint for UFO section 4 (relative to Lean):
axioms (a1)-(a108) + (inherited) structural assumptions from §§3.2-4
are jointly satisfiable.
-/
