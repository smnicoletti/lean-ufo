...
import LeanUfo.UFO.Models.RelatorRepair.Model3_1

/-!
# Analysis model for the relator repair: section 3.2
...
namespace RelatorRepair.Model3_2
...
/-- Consistency witness for §3.2 of the analysis model chain. -/
