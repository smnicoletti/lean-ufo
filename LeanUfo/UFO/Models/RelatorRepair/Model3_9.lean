...
import LeanUfo.UFO.Models.RelatorRepair.Model3_8

/-!
# Analysis model for the relator repair: section 3.9
...
namespace RelatorRepair.Model3_9
...
/-- Consistency witness for section 3.9 of the analysis model chain. -/
