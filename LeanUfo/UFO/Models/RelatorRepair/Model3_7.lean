...
import LeanUfo.UFO.Models.RelatorRepair.Model3_6

/-!
# Analysis model for the relator repair: section 3.7
...
namespace RelatorRepair.Model3_7
...
/-- Consistency witness for section 3.7 of the analysis model chain. -/
