...
import LeanUfo.UFO.Models.RelatorRepair.Model3_7

/-!
# Analysis model for the relator repair: section 3.8
...
namespace RelatorRepair.Model3_8
...
/-- Consistency witness for section 3.8 of the analysis model chain. -/
